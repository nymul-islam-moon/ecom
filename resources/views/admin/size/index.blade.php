        ...
        <div class="col-lg-12">
            ...
            <div class="card" id="invoiceList">
                <div class="card-header border-0">
                    <div class="d-flex align-items-center">
                        <h5 class="card-title mb-0 flex-grow-1">Sizes</h5>
                        <div class="flex-shrink-0">
                            <div class="d-flex gap-2 flex-wrap">
                                <button class="btn btn-primary" id="remove-actions" onclick="deleteMultiple()"><i class="ri-delete-bin-2-line"></i></button>
                                <a href="{{ route('admin.size.create') }}" class="btn btn-danger"><i class="ri-add-line align-bottom me-1"></i> Create Size</a>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="hstack gap-3 flex-wrap">
                                                <a href="{{ route('admin.size.edit', $size->id) }}" class="btn btn-link link-success fs-15 p-0 m-0 border-0">
                                                ...
                                                <form action="{{ route('admin.size.destroy', $size->id) }}" method="POST" style="display: inline;">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="btn btn-link link-danger fs-15 p-0 m-0 border-0" onclick="return confirm('Are you sure you want to delete this size?')">
