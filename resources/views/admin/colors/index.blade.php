            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="{{ route('admin.colors.index') }}">Color</a></li>
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-shrink-0">
                            <div class="d-flex gap-2 flex-wrap">
                                ...
                                <a href="{{ route('admin.colors.create') }}" class="btn btn-danger"><i class="ri-add-line align-bottom me-1"></i> Create Color</a>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="hstack gap-3 flex-wrap">
                                                <a href="{{ route('admin.colors.edit', $color->id) }}" class="btn btn-link link-success fs-15 p-0 m-0 border-0">
                                                ...
                                                <form action="{{ route('admin.colors.destroy', $color->id) }}" method="POST" style="display: inline;">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="btn btn-link link-danger fs-15 p-0 m-0 border-0" onclick="return confirm('Are you sure you want to delete this color?')">
