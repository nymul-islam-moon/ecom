                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-shrink-0">
                            <div class="d-flex gap-2 flex-wrap">
                                ...
                                <a href="{{ route('admin.customer.create') }}" class="btn btn-danger"><i class="ri-add-line align-bottom me-1"></i> Create customer</a>
                            </div>
                        </div>
                    </div>
                </div>
                                        ...
                                        <td>
                                            <div class="hstack gap-3 flex-wrap">
                                                ...
                                                <form action="{{ route('admin.customer.destroy', $customer->id) }}" method="POST" style="display: inline;">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="btn btn-link link-danger fs-15 p-0 m-0 border-0" onclick="return confirm('Are you sure you want to delete this customer?')">
