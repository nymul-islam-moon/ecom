                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-shrink-0">
                            <div class="d-flex gap-2 flex-wrap">
                                ...
                                <a href="{{ route('admin.brand.create') }}" class="btn btn-danger"><i
                                        class="ri-add-line align-bottom me-1"></i> Create Brand</a>
                            </div>
                        </div>
                    </div>
                </div>
                                        ...
                                        <td>
                                            <div class="hstack gap-3 flex-wrap">
                                                <a href="{{ route('admin.brand.edit', $brand->id) }}"
                                                    class="btn btn-link link-success fs-15 p-0 m-0 border-0">
                                                ...
                                                <form action="{{ route('admin.brand.destroy', $brand->id) }}"
                                                    ...
                                                    @method('DELETE')
                                                    <button type="submit"
                                                        class="btn btn-link link-danger fs-15 p-0 m-0 border-0"
